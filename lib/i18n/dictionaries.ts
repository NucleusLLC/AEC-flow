...
const es: Dict = {
  ...
  "Shuffle background": "Cambiar el fondo",
  "View all": "Ver todo",
...
const nl: Dict = {
  ...
  "Shuffle background": "Achtergrond wisselen",
  ...
  "Name A–Z": "Naam A–Z",
  "Pipeline value": "Pijplijnwaarde",
  "No clients match your filters": "Geen klanten voldoen aan je filters",
  "To Do": "Te doen",
...
const de: Dict = {
  ...
  "Shuffle background": "Hintergrund wechseln",
  ...
  "Name A–Z": "Name A–Z",
  "Pipeline value": "Pipeline-Wert",
  "No clients match your filters": "Keine Kunden entsprechen deinen Filtern",
  "To Do": "Zu erledigen",
...
const pt: Dict = {
  ...
  "Shuffle background": "Trocar o fundo",
  "View all": "Ver tudo",
  ...
  "Name A–Z": "Nome A–Z",
  "Pipeline value": "Valor do funil",
  "No clients match your filters": "Nenhum cliente corresponde aos seus filtros",
  "To Do": "A fazer",
...
const zh: Dict = {
  ...
  "Name A–Z": "名称 A–Z",
  "Pipeline value": "商机价值",
  "No clients match your filters": "没有符合筛选条件的客户",
  "To Do": "待办",
  "In Progress": "进行中",
  Done: "已完成",
  "Add a task…": "添加任务…",
