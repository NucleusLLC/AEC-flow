...
const STATUS_ORDER: SiteInstructionStatus[] = ["DRAFT", "ISSUED", "ACKNOWLEDGED", "CLOSED"];

export function SiteInstructionStatus({
  instructionId,
  currentStatus,
}: {
  ...
  async function submit() {
    ...
    setMsg(null);
    try {
      const res = await fetch(`/api/construction-admin/site-instructions/${instructionId}`, {
        method: "PATCH",
